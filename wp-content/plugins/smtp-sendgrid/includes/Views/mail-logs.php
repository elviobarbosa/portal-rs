...
<div class="<?php echo esc_attr( YAY_SMTP_SENDGRID_PREFIX ); ?> yay-smtp-wrap mail-logs" style="display:none">
  <div class="yay-button-first-header">
	<div class="yay-button-header-child-left">
	  <span class="dashicons dashicons-arrow-left-alt"></span>
	  <span><a href="<?php //echo YAY_SMTP_SENDGRID_SITE_URL . '/wp-admin/admin.php?page=yaysmtp' ?>" class="mail-setting-redirect">Back to Settings page</a></span>
	</div>
				  ...
				  <div class="components-other-action-control">
					<div class="components-base-control components-toggle-control">
					  <label class="components-base-control__field">
						...
						<div class="toggle-label">
						  <span class="yay-smtp-delete-all-mail-logs"><?php echo esc_html__( 'Delete All Mail Logs', 'smtp-sendgrid' ); ?></span>
						</div>
					  </label>
					</div>
				  </div>
