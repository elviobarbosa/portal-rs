...
<div class="<?php echo esc_attr( YAY_SMTP_SENDGRID_PREFIX ); ?> yay-smtp-wrap send-mail-settings-wrap">
  <div class="yay-smtp-header">
	<div class="yay-smtp-title">
	  <h2>YaySMTP for SendGrid</h2>
	</div>
	<div class="yay-button-wrap">
	  ...
	  <div class="yay-tooltip">
		<a class="yay-smtp-button panel-tab-btn other mail-logs-button" href="<?php //echo YAY_SMTP_SENDGRID_SITE_URL . '/wp-admin/admin.php?page=yaysmtp&tab=email-logs' ?>">
	  ...
	  <div class="yay-tooltip">
		<a class="yay-smtp-button panel-tab-btn other" href="https://yaycommerce.gitbook.io/yaysmtp/how-to-set-up-smtps/how-to-connect-sendgrid" target="_blank">
		  ...
		  <div class="setting-field">
			...
			<div>
			  ...
			  <div class="yay-tooltip icon-tootip-wrap">
				...
				<span class="yay-tooltiptext yay-tooltip-bottom"><?php echo esc_html__( 'Always send emails with the above From Email address, overriding other plugins settings.', 'smtp-sendgrid' ); ?></span>
			  </div>
			</div>
		  </div>
		</div>
		<div class="setting-from-name">
		  ...
		  <div class="setting-field">
			...
			<div>
			  ...
			  <div class="yay-tooltip icon-tootip-wrap">
				<span class="icon-inst-tootip"></span>
				<span class="yay-tooltiptext yay-tooltip-bottom"><?php echo esc_html__( 'Always send emails with the above From Name, overriding other plugins settings.', 'smtp-sendgrid' ); ?></span>
			  </div>
			</div>
		  </div>
		</div>
...
<?php Utils::getTemplatePart( YAY_SMTP_SENDGRID_PLUGIN_PATH . 'includes/Views', 'mail-logs' ); ?>
<!-- Mail Logs page - end -->
